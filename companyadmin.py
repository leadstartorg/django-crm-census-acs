...
from crm.utils.census_utils import fetch_census_data_for_obj, render_census_panel as _render_census_panel
...
class CompanyAdmin(CrmModelAdmin):
    ...
    def change_view(self, request, object_id,
        ...
        # JIT census lookup: runs once on first page open, then skips.
        try:
            obj = Company.objects.get(pk=object_id)
            fetch_census_data_for_obj(obj)
    ...
    def get_fieldsets(self, request, obj=None):
        return [
            ...
            *self.get_tag_fieldsets(obj),
            ...
            (_('Area Demographics (US Census Bureau)'), {
                'classes': ('collapse',),
                'fields': ('census_data_panel',),
            }),
        ]
    ...
    @admin.display(description=_('Area Demographics (US Census Bureau)'))
    def census_data_panel(self, obj):
        return _render_census_panel(obj)
